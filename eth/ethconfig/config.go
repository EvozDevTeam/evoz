...
func CreateConsensusEngine(stack *node.Node, chainConfig *params.ChainConfig, config *ethash.Config, notify []string, noverify bool, db ethdb.Database) consensus.Engine {
	...
	// TODO: In the go-ethereum codebase, the returned engine is a wrapped engine: beacon.New(engine)
	// We still return the unwrapped engine here because there will not be anything like "the merge"
	return engine
}
