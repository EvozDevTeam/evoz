...
func (st *StateTransition) TransitionDb() (*ExecutionResult, error) {
	...
	//@TODO: We will enable EIP-3529 in a future hardfork
	if !rules.IsLondon {
	...
	if st.evm.ChainConfig().POSA != nil && st.evm.ChainConfig().IsNUSAIshikari(st.evm.Context.BlockNumber) {
		// @Ishikari: Transfer all the gas fee to the fee receiver
		...
		// @TODO: Maybe we will enable EIP-1559 in the future
